...
//        $UsuBD = Usuario::create()->getUsuarioID($cod_ad);
        $UsuBD = Usuario::create()->obtenerUsuarioId($cod_ad);
//        $idUsuBD = $UsuBD[0]["id"];
        $idUsuBD = $UsuBD[0]["usuario_id"];
...
//        Util::borrarCookie();
    ...
    private function getControlador() {
        ...
        $data = Controlador::create()->obtenerControlador($this->param->opcionId, $this->param->getParametro("usuario_id"));
