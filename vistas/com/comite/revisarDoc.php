<html lang="es">
    ...
    <body>
        <div class="page-title">
            <h3 class="title">Aprobaci&oacute;n de documentos</h3>
        </div>
        <div class="row">
            <div class="panel panel-default">
                ...
                <div style="clear:left">
                    <p><b>Leyenda:</b>&nbsp;&nbsp;
                        <i class="fa fa-close" style="color:#cb2a2a;"></i>Revisión: rechazar&nbsp;&nbsp;&nbsp;
                        <i class='fa fa-check' style="color:#5cb85c;"></i>Revisión: aprobar&nbsp;&nbsp;&nbsp;
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="hdnDocumentoId" value="" />
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger w-sm m-b-5" data-dismiss="modal">
                            <i class="fa fa-close"></i>&ensp;Cancelar
                        </button>&nbsp;&nbsp;&nbsp;
                        <button type="button" id="btnGuardar" name="btnGuardar" class="btn btn-info w-sm m-b-5" 
                                style="border-radius: 0px;" onclick="rechazar()">
        ...
        <script src="vistas/com/comite/revisarDoc.js"></script>
    </body>
</html>
