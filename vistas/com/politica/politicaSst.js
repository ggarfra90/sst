...
function listarPoliticaSst() {
    ax.setAccion("listarPoliticaSst");
    ax.consumir();
}
...
function exitoPoliticaSst(response) {
    if (response.status === 'ok') {
        switch (response[PARAM_ACCION_NAME]) {
            case 'listarPoliticaSst':
                onResponseListarPoliticaSst(response.data);
                onResponseVacio();
                break;
            case 'cambiarEstado':
                cambiarIconoEstado();
...
function nuevo() {
    var titulo = "Nueva";
    var url = URL_BASE + "vistas/com/politica/politicaSst_form.php?winTitulo=" + titulo;
    cargarDiv("#window", url);
}

function onResponseListarPoliticaSst(data) {
    $("#dataList").empty();
    var cuerpo_total = "";
    var cuerpo = "";
    var cuerpo_acc = "";
...
function verDetalle(id) {
    ...
    var url = URL_BASE + "vistas/com/politica/politicaSst_form.php?winTitulo=" + titulo + "&id=" + id + "&readonly=true";
    cargarDiv("#window", url);
}

function editar(id) {
    var titulo = "Editar";
    var url = URL_BASE + "vistas/com/politica/politicaSst_form.php?winTitulo=" + titulo + "&id=" + id + "&readonly=false";
    cargarDiv("#window", url);
}
