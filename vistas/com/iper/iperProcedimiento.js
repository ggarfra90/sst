...
function listarIperProcedimiento(){
    ax.setAccion("listarIperProcedimiento");
    ax.consumir();
}
...
function nuevo() {
    var titulo = "Nuevo";
    var url = URL_BASE + "vistas/com/iper/iperProcedimiento_form.php?winTitulo=" + titulo;
    cargarDiv("#window", url);
}

function onResponseListarIperProcedimiento(data) {
    $("#dataList").empty();
    var cuerpo_total = "";
    var cuerpo = "";
    var cuerpo_acc = "";
...
function verDetalle(id) {
    ...
    var url = URL_BASE + "vistas/com/iper/iperProcedimiento_form.php?winTitulo=" + titulo + "&id=" + id + "&readonly=true";
    cargarDiv("#window", url);
}

function editar(id) {
    var titulo = "Editar";
    var url = URL_BASE + "vistas/com/iper/iperProcedimiento_form.php?winTitulo=" + titulo + "&id=" + id + "&readonly=false";
    cargarDiv("#window", url);
}
