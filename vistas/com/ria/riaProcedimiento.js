...
$(document).ready(function () {
    ...
    listarRiaProcedimiento();

    cargarComponentes();
    altura();
});

function listarRiaProcedimiento(){
    ax.setAccion("listarRiaProcedimiento");
    ax.consumir();
}
...
function exitoRiaProcedimiento(response) {
    if (response.status === 'ok') {
        switch (response[PARAM_ACCION_NAME]) {
            case 'listarRiaProcedimiento':
                onResponseListarRiaProcedimiento(response.data);
                onResponseVacio();
                break;
            case 'cambiarEstado':
                cambiarIconoEstado();
...
function nuevo() {
    var titulo = "Nuevo";
    var url = URL_BASE + "vistas/com/ria/riaProcedimiento_form.php?winTitulo=" + titulo;
    cargarDiv("#window", url);
}

function onResponseListarRiaProcedimiento(data) {
    $("#dataList").empty();
    var cuerpo_total = "";
    var cuerpo = "";
    var cuerpo_acc = "";
...
function verDetalle(id) {
    ...
    var url = URL_BASE + "vistas/com/ria/riaProcedimiento_form.php?winTitulo=" + titulo + "&id=" + id + "&readonly=true";
    cargarDiv("#window", url);
}

function editar(id) {
    var titulo = "Editar";
    var url = URL_BASE + "vistas/com/ria/riaProcedimiento_form.php?winTitulo=" + titulo + "&id=" + id + "&readonly=false";
    cargarDiv("#window", url);
}
