<html lang="es">
    ...
    <body>
        <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><?php echo $_GET['winTitulo']; ?> procedimiento RIA</h3>
                </div>
                <div class="panel-body">
                    <form  id="frmRiaProcedimiento" method="post" class="form" enctype="multipart/form-data;charset=UTF-8">
                        <div class="row">
        ...
        <script src="vistas/com/ria/riaProcedimiento_form.js"></script>
    </body>
</html>
