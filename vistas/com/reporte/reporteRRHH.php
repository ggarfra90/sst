<html lang="es">
    ...
    <body >
        <div class="page-title">
            <h3 class="title">Reporte RRHH</h3>
        </div>
        <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div style="clear:left">
                    <p><b>Leyenda:&nbsp;&nbsp;</b>
                        <a class="accionComentar" title="Comentar"><i class="fa fa-weixin"></i></a> Comentar &nbsp;&nbsp;&nbsp;
                ...
                <div id="modal" class="modal fade" role="dialog" data-backdrop="static">
                 ...
                 <div id="modalComentario" class="modal fade" role="dialog" data-backdrop="static">
                    <div class="modal-dialog">
                        <!-- Modal content-->
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div  class="modal-body">
                                ...
                                <textarea id="comentario" class="form-control" rows="7" maxlength="500"></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-info" onclick="comentar()"><i class="fa fa-save"></i> Comentar</button>
                                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa ion-android-close"></i> Cerrar</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="vistas/com/reporte/reporteRRHH.js"></script>
    </body>
