<html lang="es">
    ...
    <body >
        <div class="page-title">
            <h3 class="title">Gráfico inmediato</h3>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-inline" role="form" target="_blank" action="vistas/com/reporte/graficoInmediatoPDF.php" method="post">
        ...
        <script src="vistas/com/reporte/graficoInmediato.js"></script>
    </body>
