    ...
    <body >
        ...
        <div class="row">
            ...
            <div class="panel panel-default">
                <a style="border-radius: 0px;" class="btn btn-info w-md" onclick="nuevo()"><i class=" fa fa-pencil" style="font-size: 18px;"></i>&nbsp;&nbsp;<i> </i><i> </i>Nueva</a>
                <br><br>
                ...
                <div style="clear:left">
                    <p><b>Leyenda:&nbsp;&nbsp;</b>
                        ...
                        <a class="accionVisualizar" title="Visualizar"><i class="fa fa-search"></i></a> Visualizar &nbsp;&nbsp;&nbsp;
                    </p>
                </div>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-info" onclick="nuevaEvaluacion()"><i class="fa ion-arrow-right-c"></i> Siguiente</button>
        ...
        <script src="vistas/com/evaluacion/evaluacion.js"></script>
    </body>
