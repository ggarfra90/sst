<html lang="es">
    ...
    <body>
        <div class="page-title">
            <h3 class="title">Mapa de riesgo</h3>
        </div>
        <div class="row">
            <div class="panel panel-default">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <button type="button" id="btnBuscar" name="btnBuscar" class="btn btn-info w-sm m-b-5" 
                                style="border-radius: 0px;" onclick="buscarMapaRiesgo()">
        ...
        <script src="vistas/com/mapaRiesgo/mapa.js"></script>
    </body>
</html>
