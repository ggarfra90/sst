<html lang="es">
    ...
    <body>
        <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><?php echo $_GET['winTitulo']; ?> reglamento SST</h3>
                </div>
                <div class="panel-body">
                    <form  id="frmReglamentoSst" method="post" class="form" enctype="multipart/form-data;charset=UTF-8">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <span id="msjVersion" class="control-label" style="color:red;font-style: normal;" hidden></span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Pol&iacute;tica *</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select id="cboPolitica" name="cboPolitica" class="select2">
                                    </select>
                                </div>
                                <span id="msjPolitica" class="control-label" style="color:red;font-style: normal;" hidden></span>
                            </div>
        ...
        <script src="vistas/com/reglamento/reglamentoSst_form.js"></script>
    </body>
</html>
